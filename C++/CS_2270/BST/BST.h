...
public:
  ...
  // recursive helper function to Insert function
  void InsertRecursive(shared_ptr<bst_node> new_node, shared_ptr<bst_node> cursor);
  ...
  // recursive helper function to Contains
  bool ContainsRecursive(shared_ptr<bst_node> cursor, int data, bool& ret);
  ...
  // recursive helper function for GetNode
  shared_ptr<bst_node> GetNodeRecursive(shared_ptr<bst_node> cursor, int data, shared_ptr<bst_node>& ret);
  ...
  // recursive helper function to Size to return size of subt
  int SizeRecursive(shared_ptr<bst_node> cursor, int& size);
  ...
  // recursive helper function to ToVector
  void ToVectorRecursive(shared_ptr<bst_node> cursor, vector<int>& vec);
